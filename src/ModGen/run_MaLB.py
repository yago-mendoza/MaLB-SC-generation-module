...
if __name__ == '__main__':
    ...
    Results
    - contracts: generation_module/output/{self.session}/contracts
    '''
    ...
    Results:
    - compilation_logs: static_linting/output/compiler/<session>/compilation_logs
    - compiled_contracts: static_linting/output/compiler/<session>/compiled_contracts
    - execution_log: static_linting/output/compiler/<session>/execution_log
    '''
    ...
    Results:
    - analysis_logs: static_linting/output/solhint/<session>/analysis_logs
    '''
