...
contract VIPAuction {
    ...
    constructor(uint _auctionDuration, uint _extensionDuration, uint _bidIncrement, uint _minBidIncreasePercentage, uint _totalTokens) {
    ...
    function placeBid() external payable {
        ...
        require(bidderBidCount[msg.sender] < 3, "Maximum bid count reached for this address");
