...
contract VIPAuction {
    ...
    function placeBid() external payable {
        ...
        if (highestBidder != address(0)) {
            ...
            addressBidCount[previousHighestBidder]--;
            ...
            payable(previousHighestBidder).transfer(previousHighestBid); // Refund previous highest bidder
        } else {
            highestBidder = msg.sender;
            highestBid = msg.value;
            addressBidCount[msg.sender]++;
    ...
    function withdraw() external {
        ...
        payable(organizer).transfer(highestBid); // Transfer funds to organizer
    }
}