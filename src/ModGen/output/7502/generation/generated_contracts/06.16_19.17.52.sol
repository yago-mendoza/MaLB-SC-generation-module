...
contract VIPAuction {
    ...
    constructor(uint _bidIncrementPercentage, uint _auctionDuration) {
    ...
    function placeBid() external payable onlyDuringAuction {
        ...
        require(msg.value >= highestBid * minBidIncrease / 100, "Bid amount must be at least 5% higher than current highest bid");
    ...
    function withdraw() external onlyOrganizer {
        ...
        require(!auctionEnded, "Withdrawal already made");
