...
contract VIPAuction {
    ...
    constructor() {
        ...
        auctionEndTime = block.timestamp + 1 hours; // Set initial auction time to 1 hour from contract deployment
    }
    ...
    function placeBid(uint _bidAmount) external payable {
        ...
        if (_bidAmount > highestBid) {
            ...
            // Extend auction by 10 minutes if new highest bid in last 5 minutes
