...
contract VIPAuction {
    ...
    constructor() {
        ...
        auctionEndTime = block.timestamp + 1 hours; // Set the initial auction duration to 1 hour
    }
    ...
    function placeBid() external payable {
        ...
        if (auctionEndTime - block.timestamp < 5 minutes) {
            auctionEndTime += 10 minutes; // Extend the auction by 10 minutes if new bid in last 5 minutes
        }
    }
